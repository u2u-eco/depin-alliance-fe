          ...
          <div className="relative w-fit mx-auto">
            ...
            <div className="absolute top-0 left-0 right-0 w-full h-full flex items-center space-x-4 p-4">
              <div className="relative">
                ...
                <img className="size-[140px]" src="/assets/images/workspace/workspace-image.png" srcSet="/assets/images/workspace/workspace-image.png 1x, /assets/images/workspace/workspace-image@2x.png 2x" alt="" />
              </div>
              <div className="space-y-6">
                <div className="space-y-3">
                  <div className="text-white font-airnt font-medium text-base tracking-[1px]">Workspace</div>
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-1">
                        <img src="/assets/images/icons/icon-device-gray.svg" alt="" className="size-4" />
                        <p className="text-green-500 font-semibold">05</p>
                      </div>
                    </div>
                  </div>
                </div>
                <Link href="/workspace" className="flex items-center space-x-1">
                  ...
                  <img src="/assets/images/icons/icon-open-link-gradient.svg" alt="" className="size-6" />
                </Link>
              </div>
            </div>
          </div>
