...
function Icon({ className, gradient }: IconProps) {
  return gradient ? (
    ...
    >
      <path
        d="M26.6673 29H21.334C20.7873 29 20.334 28.5467 20.334 28C20.334 27.4533 20.7873 27 21.334 27H26.6673C27.214 27 27.6673 27.4533 27.6673 28C27.6673 28.5467 27.214 29 26.6673 29Z"
        fill="url(#paint0_linear_4001_575)"
      />
      <path
        d="M24 31.6667C23.4533 31.6667 23 31.2133 23 30.6667V25.3333C23 24.7867 23.4533 24.3333 24 24.3333C24.5467 24.3333 25 24.7867 25 25.3333V30.6667C25 31.2133 24.5467 31.6667 24 31.6667Z"
        fill="url(#paint1_linear_4001_575)"
      />
      <path
        d="M18.2136 17.4933C18.1736 17.4933 18.1469 17.4933 18.1069 17.4933C18.0403 17.48 17.9469 17.48 17.8669 17.4933C14.0003 17.3733 11.0803 14.3333 11.0803 10.5867C11.0669 8.74666 11.7869 7.01332 13.0936 5.70666C14.4003 4.39999 16.1336 3.66666 17.9869 3.66666C21.8003 3.66666 24.9069 6.77332 24.9069 10.5867C24.9069 14.3333 21.9869 17.36 18.2536 17.4933C18.2403 17.4933 18.2269 17.4933 18.2136 17.4933ZM17.9869 5.66666C16.6669 5.66666 15.4403 6.18666 14.5069 7.10666C13.5869 8.03999 13.0803 9.26666 13.0803 10.5733C13.0803 13.24 15.1603 15.4 17.8136 15.48C17.8936 15.4667 18.0669 15.4667 18.2403 15.48C20.8669 15.36 22.9069 13.2133 22.9069 10.5733C22.9069 7.87999 20.6936 5.66666 17.9869 5.66666Z"
        fill="url(#paint2_linear_4001_575)"
      />
      <path
        ...
        fill="url(#paint3_linear_4001_575)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_4001_575"
          x1="20.334"
          y1="28"
          x2="27.6673"
          y2="28"
    ...
    >
      ...
      />
      <path
        d="M15.1993 13.5875C15.0743 13.575 14.9243 13.575 14.7868 13.5875C11.8118 13.4875 9.44927 11.05 9.44927 8.05C9.43677 4.9875 11.9243 2.5 14.9868 2.5C18.0493 2.5 20.5368 4.9875 20.5368 8.05C20.5368 11.05 18.1618 13.4875 15.1993 13.5875Z"
        stroke="currentColor"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path
        d="M14.9883 27.2625C12.7133 27.2625 10.4508 26.6875 8.72578 25.5375C5.70078 23.5125 5.70078 20.2125 8.72578 18.2C12.1633 15.9 17.8008 15.9 21.2383 18.2"
        stroke="currentColor"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
