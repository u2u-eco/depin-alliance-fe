...
const CustomNavbar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-20">
      <div className="relative before:content-[''] before:absolute before:top-0 before:left-0 before:opacity-20 before:w-full before:h-2.5 before:bg-[linear-gradient(to_bottom,rgba(0,51,29,00),rgba(0,51,29,1))]">
            ...
            {item.id === 3 ? (
              <div className="btn w-fit -mt-12 group bg-transparent">
                ...
                <div className="btn-primary group-hover:bg-gradient !p-3 shadow-[0_0_16px_rgba(123,255,99,0.35)]">
                  <img className="size-8" src={`/assets/images/icons/icon-${item.title}.svg`} alt="Icon Contribute" />
                </div>
                <div className="btn-border"></div>
              </div>
            ) : (
