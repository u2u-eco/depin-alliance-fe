  ...
  return (
    <>
      {arrow ? (
        ...
        <div
          className={`flex flex-col ${!hideImage ? (placement === 'top-center' || placement === 'top-right' ? '' : 'pt-10 2xs:pt-16') : ''} ${pathName !== '/map' ? (tourState.stepIndex === 4 ? 'pr-5' : tourState.stepIndex === 7 ? 'pl-10 max-[354px]:pt-8' : 'pl-5') : 'pl-5'}`}
        >
          <div
