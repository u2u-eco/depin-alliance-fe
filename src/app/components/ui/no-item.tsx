...
export default function NoItem({ title, classNames, link, textLink }: ItemProps) {
  return (
    <div className={cn('min-h-[160px] xs:min-h-[200px] 2xs:min-h-[240px] flex items-center justify-center flex-col space-y-2.5 xs:space-y-3 2xs:space-y-4', classNames?.wrapper)}>
