...
export default function MapBackground() {
  ...
  const [missionActive, setMissionActive] = useState<{ [key: number]: boolean }>({})
  ...
  const handleOpenPopover = (id: number, open: boolean) => {
    isOpenPopoverById.current[id] = open
                  ...
                  >
                    <RStyle.RStyle>
                      <RStyle.RIcon
                        ...
                        anchor={[0.5, item?.isCompleted ? 1.1 : 1.3]}
                      />
